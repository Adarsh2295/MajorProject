...
const dropdownData = [
    { title: "Job Title", icon: IconBriefcase, options: ['Designer', 'Developer', 'Product Manager', 'Marketing Specialist', 'Data Analyst', 'Sales Executive', 'Content Writer', 'Customer Support'] },
    { title: "Location", icon: IconMapPin, options: ['Delhi', 'New York', 'San Francisco', 'London', 'Berlin', 'Tokyo', 'Sydney', 'Toronto'] },
    { title: "Experience", icon: IconRecharging, options: ['Entry Level', 'Intermediate', 'Expert'] },
    { title: "Job Type", icon: IconSearch, options: ['Full Time', 'Part Time', 'Contract', 'Freelance', 'Internship'] }
]
...
const jobList = [
    ...
    },
    {
      ...
      package: "35 LPA",
      postedDaysAgo: 4,
      description: "Join Microsoft. We're looking for designers who can create intuitive and compelling gaming experiences. This is a remote position, offering flexibility and the opportunity to work with a leading technology company."
    },
    {
      jobTitle: "Product Designer",
      company: "Adobe",
