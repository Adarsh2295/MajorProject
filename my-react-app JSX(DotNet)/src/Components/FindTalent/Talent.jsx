...
const Talents=()=>{
    ...
    useEffect(()=>{
        ...
        getAllProfiles().then((res) => {
            ...
            // For now, show all profiles since most don't have complete data
            // In a production app, you'd filter based on user type or profile completeness
            ...
            console.log("Showing all profiles because filtered list is empty or incomplete");
            // Always show all profiles for now since most are incomplete
            setTalents(res);
        }).catch((error) => {
            console.log(error);
        })
