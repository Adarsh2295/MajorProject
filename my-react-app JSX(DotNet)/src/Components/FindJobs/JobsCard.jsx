    ...
    return(
       <div className="bg-mine-shaft-900 p-4 w-72 md-mx:64 sm-mx:w-64 xs-mx:w-full flex flex-col gap-5 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400 cursor-pointer">
            <div className="flex justify-between">
                ...
                <div>
                    {Array.isArray(profile.savedJobs) && profile.savedJobs.includes(props.id)?<IconBookmarkFilled onClick={handleSavedJob} className="text-bright-sun-400 cursor-pointer" stroke={1.5}/>:<IconBookmark onClick={handleSavedJob} className="hover:text-bright-sun-400 text-mine-shaft-300 cursor-pointer" stroke={1.5}/>}
                </div>
            </div>
