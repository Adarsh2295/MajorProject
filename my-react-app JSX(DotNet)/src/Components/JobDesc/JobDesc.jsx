...
const JobDesc=(props)=>{
    ...
    const handleClose=()=>{
        const jobData = {
            ...props,
            jobStatus: 1, // 1 for CLOSED enum value
            postedBy: props.postedBy || props.PostedBy,
            ...
            <div className="flex justify-between items-center flex-wrap">
                <div className="flex gap-3 items-center">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="text-lg text-mine-shaft-300 flex flex-wrap xs-mx:text-base">{props.company} &bull;&nbsp;{timeAgo(props.postTime||"")} &bull;&nbsp;{props.applicants?props.applicants.length:0} Applicants</div>
                    </div>
                </div>
