                        ...
                        <div className="space-y-6">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-mine-shaft-700 dark:text-mine-shaft-200">support@talenttrace.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-mine-shaft-700 dark:text-mine-shaft-200">+1 (555) 123-4567</p>
                                </div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        className="w-full px-4 py-3 bg-gray-100 dark:bg-mine-shaft-800 border border-gray-300 dark:border-mine-shaft-700 rounded-lg text-mine-shaft-900 dark:text-white focus:outline-none focus:border-bright-sun-400 transition-colors"
                                        placeholder="Your full name"
                                    />
                                </div>

                                <div>
                                    <label htmlFor="email" className="block text-sm font-medium text-mine-shaft-700 dark:text-mine-shaft-200 mb-2">
                                        Email Address *
                                    </label>
                                    <input
                                        type="email"
                                ...
                                <div>
                                    <label htmlFor="subject" className="block text-sm font-medium text-mine-shaft-700 dark:text-mine-shaft-200 mb-2">
                                        Subject *
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label htmlFor="message" className="block text-sm font-medium text-mine-shaft-700 dark:text-mine-shaft-200 mb-2">
                                        Message *
                                    </label>
                                    <textarea
                                        id="message"
                                        ...
                                        required
                                        rows={5}
                                        className="w-full px-4 py-3 bg-gray-100 dark:bg-mine-shaft-800 border border-gray-300 dark:border-mine-shaft-700 rounded-lg text-mine-shaft-900 dark:text-white focus:outline-none focus:border-bright-sun-400 transition-colors resize-vertical"
